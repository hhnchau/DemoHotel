...
//            String url = UrlParams.MAIN_URL + "/hotelapi/promotion/download/downloadPromotionImage?promotionImageSn=" + noticeForm.getPromotionImageFormList().get(0).getSn() + "&fileName=" + imageName;
