 ...
 */
public class ChooseHotelAreaAdapter extends BaseAdapter {

    private Context context;
    private List<District> data;
    private OnUpdateFavoriteListener onUpdateFavoriteListener;

    public ChooseHotelAreaAdapter(Context context, List<District> data, OnUpdateFavoriteListener onUpdateFavoriteListener) {
        this.data = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.choose_hotel_area_item, parent, false);
...
//                userAreaFavoriteDto.setProvinceSn(data.get(position).getProvinceSn());
                                ...
                                if (restResult.getResult() == 1) {
                                    ...
                                    DialogUtils.showExpiredDialog(context, new DialogCallback() {
                                        ...
                                        public void finished() {
                                            ...
                                            ((Activity) context).startActivityForResult(intent, ParamConstants.LOGIN_DETAIL_REQUEST_LIKE);
                                        }
                                    });
                                }
    ...
    private class ViewHolder {
        ...
        TextViewSFRegular tvTotalHotel;
        ImageView btnLike;
    }
