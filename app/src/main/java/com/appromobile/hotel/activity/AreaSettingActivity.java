 ...
 */
public class AreaSettingActivity extends BaseActivity implements HotelAreaAdapter.OnUpdateFavoriteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvProvinces.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,final int position, long id) {
                ...
                DialogUtils.showLoadingProgress(AreaSettingActivity.this, false);
                HotelApplication.serviceApi.findAllDistrictInProvince(params, HotelApplication.DEVICE_ID).enqueue(new Callback<List<District>>() {
                    ...
                    public void onResponse(Call<List<District>> call, Response<List<District>> response) {
                        ...
                        if (response.isSuccessful()) {
                            hotelAreaAdapter = new HotelAreaAdapter(AreaSettingActivity.this, response.body(), AreaSettingActivity.this);
                    ...
                    public void onFailure(Call<List<District>> call, Throwable t) {
                        DialogUtils.hideLoadingProgress();
                        Toast.makeText(AreaSettingActivity.this, getString(R.string.cannot_connect_to_server), Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
        ...
        HotelApplication.serviceApi.findAllProvinceCity(params, HotelApplication.DEVICE_ID).enqueue(new Callback<List<Province>>() {
            ...
            public void onResponse(Call<List<Province>> call, Response<List<Province>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    provinceAdapter = new ProvinceAdapter(AreaSettingActivity.this, provinces);
        ...
        if (address != null) {
            ...
            if (provinceSn != 0) {
                ...
                if (provinces != null && provinces.size() > 0) {
                    provinceSn = provinces.get(1).getSn();
                }
                params.put("provinceSn", provinceSn);
            }
            DialogUtils.showLoadingProgress(AreaSettingActivity.this, false);
